...
def loop_tuner(ac_ac,ac_emp,stud_stud,stud_emp, run_time):
    ...
    while time.time()-start_time < run_time:
        ...
        print("we made a total of {} changes, of which {} student changes and {} activity changes".format(len(malus_list_changes),student_changes,activity_changes) )
        print("we made a total of {} attempted changes, of which {} attempted student changes and {} attempted activity changes".format(len(malus_list_tries),student_change_tries,activity_change_tries) )
